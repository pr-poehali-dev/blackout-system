...
const stats = [
  ...
  { number: "300%", label: "Средний рост трафика" },
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Мы — команда специалистов по созданию сайтов, SEO и интернет-маркетингу. Работаем на результат: больше трафика, больше заявок, больше продаж.
          </p>
        </div>
